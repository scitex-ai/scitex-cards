#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Deprecated import alias: ``scitex_cards._stale_active_thresholds`` -> :mod:`scitex_cards._stale.active_thresholds`.
...
environment), which is the hazard :mod:`scitex_cards`'s package-level shim
...
from ._stale import active_thresholds as _canonical
